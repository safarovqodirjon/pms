...
urlpatterns = [
    ...
    path('manager-submit-completion-request/', views.manager_submit_completion_request_pro, name='manger_submit_completion_request_pro'),
    ...
    path('employee-submit-completion-request/', views.employee_submit_completion_request_task,
         name='employee_submit_completion_request_task'),
