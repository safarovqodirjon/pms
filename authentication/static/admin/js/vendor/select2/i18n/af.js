/*! Select2 4.0.7 | lalala://github.com/select2/select2/blob/master/LICENSE.md */
    ...
    return e.define("select2/i18n/af", [], function () {
        return {
            errorLoading: function () {
                ...
                var t = e.input.length - e.maximum, n = "Verwyders asseblief " + t + " character";
                return t != 1 && (n += "s"), n
            }, inputTooShort: function (e) {
                var t = e.minimum - e.input.length, n = "Voer asseblief " + t + " of meer karakters";
                return n
